...
def resize_and_crop(in_memory_uploaded_file, size, crop_type='top'):
  """
  ...
  img = Image.open(in_memory_uploaded_file)
  ...
  return InMemoryUploadedFile(output, 'ImageField', "%s.jpg" % in_memory_uploaded_file.name.split('.')[0], 'image/jpeg',
